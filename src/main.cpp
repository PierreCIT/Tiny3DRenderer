...
int main(int argc, char **argv) {
    ...
    image_line.write_tga_file("../images/output.tga");
    ...
    image_wireframe.write_tga_file("../images/african_head_wireframe.tga");
    ...
    image_wireframe_randomColordFilled.write_tga_file("../images/WireFrame_triangles_filled.tga");
    ...
    image_wireframe_light_intensity.write_tga_file("../images/WireFrame_light_intensity.tga");
...
//    image_triangles.write_tga_file("../images/Triangles.tga");
//
...
//    image_filled_triangles.write_tga_file("../images/Triangles_filled.tga");
