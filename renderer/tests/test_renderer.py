...
def test_draw_triangles(cam_renderer_wireframe) -> None:
    cam, renderer = cam_renderer_wireframe
    t1 = {"a": (10, 70), "b": (50, 160), "c": (70, 80), "colors": [ColorMap.RED.value, ColorMap.RED.value, ColorMap.RED.value]}
    t2 = {"a": (180, 50), "b": (150, 1), "c": (70, 180), "colors": [ColorMap.WHITE.value, ColorMap.WHITE.value, ColorMap.WHITE.value]}
    t3 = {"a": (180, 150), "b": (120, 160), "c": (130, 180), "colors": [ColorMap.GREEN.value, ColorMap.GREEN.value, ColorMap.GREEN.value]}
    line = {"a": (20, 20), "b": (20, 20), "c": (30, 32), "colors": [ColorMap.MAGENTA.value, ColorMap.MAGENTA.value, ColorMap.MAGENTA.value]}
...
def test_draw_triangles_interpolate(cam_renderer_wireframe) -> None:
    cam, renderer = cam_renderer_wireframe
    t1 = {"a": (10, 10), "b": (100, 30), "c": (190, 160), "colors": [ColorMap.RED.value, ColorMap.GREEN.value, ColorMap.BLUE.value]}
    t2 = {"a": (200, 270), "b": (250, 360), "c": (270, 280), "colors": [ColorMap.RED.value, ColorMap.GREEN.value, ColorMap.BLUE.value]}
    renderer.draw_triangle(**t1)
    renderer.draw_triangle(**t2)
