...
class Camera(Model):
    ...
    def __init__(self, name: str,
        ...
        self.lookat: None | Pose = None  # For a test only, default should be None
    ...
    def to_camera_space_matrix(self, v) -> tuple[np.ndarray, np.ndarray]:
        v_in_cam = self.pose.to_matrix().I @ v
        outliers = np.where(v_in_cam[2, :] < self.near)[1]
